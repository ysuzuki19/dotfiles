...
(function() {
  var CoreScroller, Scroller, activatedElement, checkVisibility, doesScroll, findScrollableElement, firstScrollableElement, fn, getDimension, getScrollingElement, getSign, i, isScrollableElement, len, method, performScroll, ref, root, scrollProperties, shouldScroll;
  ...
  if (DomUtils.isTopFrame() && window.location.host === "twitter.com") {
    ref = ["scrollTo", "scrollBy"];
    fn = function() {
      var func;
      func = Scroller[method];
      return Scroller[method] = function() {
        var element;
        element = document.querySelector("div.permalink-container div.permalink[role=main]");
        activatedElement = element != null ? element : getScrollingElement();
