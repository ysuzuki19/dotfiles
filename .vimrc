...
if has("autocmd")
  ...
  autocmd FileType typescriptreact  nnoremap <buffer> <C-i> I//<Esc>
  autocmd FileType typescriptreact  nnoremap <buffer> <C-f> I<Del><Del><Esc>
  ...
  autocmd FileType vim         nnoremap <buffer> <C-i> I"<Esc>
  autocmd FileType vim         nnoremap <buffer> <C-f> I<Del><Esc>

  autocmd FileType cmake       setlocal sw=2 sts=2 ts=2 et
  autocmd FileType cmake       nnoremap <buffer> <C-i> I#<Esc>
  autocmd FileType cmake       nnoremap <buffer> <C-f> I<Del><Esc>
endif
